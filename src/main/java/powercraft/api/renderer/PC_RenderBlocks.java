...
public class PC_RenderBlocks extends RenderBlocks {
	...
	public boolean renderStandardBlockWithAmbientOcclusion(Block par1Block, int par2, int par3, int par4, float par5, float par6, float par7){
        ...
        if (this.renderAllFaces || shouldSideBeRendered(par1Block, par2, par3 - 1, par4, 0))
        {
            ...
            this.aoLightValueScratchXYNN = this.blockAccess.getBlock(par2 - 1, par3, par4).getAmbientOcclusionLightValue();
            this.aoLightValueScratchYZNN = this.blockAccess.getBlock(par2, par3, par4 - 1).getAmbientOcclusionLightValue();
            this.aoLightValueScratchYZNP = this.blockAccess.getBlock(par2, par3, par4 + 1).getAmbientOcclusionLightValue();
            this.aoLightValueScratchXYPN = this.blockAccess.getBlock(par2 + 1, par3, par4).getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZNNN = this.blockAccess.getBlock(par2 - 1, par3, par4 - 1).getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZNNP = this.blockAccess.getBlock(par2 - 1, par3, par4 + 1).getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZPNN = this.blockAccess.getBlock(par2 + 1, par3, par4 - 1).getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZPNP = this.blockAccess.getBlock(par2 + 1, par3, par4 + 1).getAmbientOcclusionLightValue();
        ...
        if (this.renderAllFaces || shouldSideBeRendered(par1Block, par2, par3 + 1, par4, 1))
        {
            ...
            this.aoLightValueScratchXYNP = this.blockAccess.getBlock(par2 - 1, par3, par4).getAmbientOcclusionLightValue();
            this.aoLightValueScratchXYPP = this.blockAccess.getBlock(par2 + 1, par3, par4).getAmbientOcclusionLightValue();
            this.aoLightValueScratchYZPN = this.blockAccess.getBlock( par2, par3, par4 - 1).getAmbientOcclusionLightValue();
            this.aoLightValueScratchYZPP =this.blockAccess.getBlock(par2, par3, par4 + 1).getAmbientOcclusionLightValue();
            flag3 = this.blockAccess.getBlock(par2 + 1, par3 + 1, par4).getCanBlockGrass();
            flag2 = this.blockAccess.getBlock(par2 - 1, par3 + 1, par4).getCanBlockGrass();
            flag5 = this.blockAccess.getBlock(par2, par3 + 1, par4 + 1).getCanBlockGrass();
            flag4 = this.blockAccess.getBlock(par2, par3 + 1, par4 - 1).getCanBlockGrass();
            ...
            {
                this.aoLightValueScratchXYZNPN = this.blockAccess.getBlock(par2 - 1, par3, par4 - 1).getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZPPN = this.blockAccess.getBlock( par2 + 1, par3, par4 - 1).getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZNPP = this.blockAccess.getBlock(par2 - 1, par3, par4 + 1).getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZPPP = this.blockAccess.getBlock(par2 + 1, par3, par4 + 1).getAmbientOcclusionLightValue();
        ...
        if (this.renderAllFaces || shouldSideBeRendered(par1Block, par2, par3, par4 - 1, 2))
        {
            ...
            this.aoLightValueScratchXZNN = this.blockAccess.getBlock(par2 - 1, par3, par4).getAmbientOcclusionLightValue();
            this.aoLightValueScratchYZNN = this.blockAccess.getBlock(par2, par3 - 1, par4).getAmbientOcclusionLightValue();
            this.aoLightValueScratchYZPN = this.blockAccess.getBlock(par2, par3 + 1, par4).getAmbientOcclusionLightValue();
            this.aoLightValueScratchXZPN = this.blockAccess.getBlock(par2 + 1, par3, par4).getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZNNN = this.blockAccess.getBlock(par2 - 1, par3 - 1, par4).getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZNPN = this.blockAccess.getBlock(par2 - 1, par3 + 1, par4).getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZPNN = this.blockAccess.getBlock(par2 + 1, par3 - 1, par4).getAmbientOcclusionLightValue();
            ...
            {
               this.aoLightValueScratchXYZPPN = this.blockAccess.getBlock(par2 + 1, par3 + 1, par4).getAmbientOcclusionLightValue();
        ...
        if (this.renderAllFaces || shouldSideBeRendered(par1Block, par2, par3, par4 + 1, 3))
        {
            ...
            this.aoLightValueScratchXZNP = this.blockAccess.getBlock(par2 - 1, par3, par4).getAmbientOcclusionLightValue();
            this.aoLightValueScratchXZPP = this.blockAccess.getBlock(par2 + 1, par3, par4).getAmbientOcclusionLightValue();
            this.aoLightValueScratchYZNP = this.blockAccess.getBlock(par2, par3 - 1, par4).getAmbientOcclusionLightValue();
            this.aoLightValueScratchYZPP = this.blockAccess.getBlock(par2, par3 + 1, par4).getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZNNP = this.blockAccess.getBlock(par2 - 1, par3 - 1, par4).getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZNPP = this.blockAccess.getBlock(par2 - 1, par3 + 1, par4).getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZPNP = this.blockAccess.getBlock(par2 + 1, par3 - 1, par4).getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZPPP = this.blockAccess.getBlock(par2 + 1, par3 + 1, par4).getAmbientOcclusionLightValue();
        ...
        if (this.renderAllFaces || shouldSideBeRendered(par1Block, par2 - 1, par3, par4, 4)){
            ...
            this.aoLightValueScratchXYNN = this.blockAccess.getBlock( par2, par3 - 1, par4).getAmbientOcclusionLightValue();
            this.aoLightValueScratchXZNN = this.blockAccess.getBlock(par2, par3, par4 - 1).getAmbientOcclusionLightValue();
            this.aoLightValueScratchXZNP = this.blockAccess.getBlock(par2, par3, par4 + 1).getAmbientOcclusionLightValue();
            this.aoLightValueScratchXYNP = this.blockAccess.getBlock(par2, par3 + 1, par4).getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZNNN = this.blockAccess.getBlock(par2, par3 - 1, par4 - 1).getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZNNP = this.blockAccess.getBlock(par2, par3 - 1, par4 + 1).getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZNPN = this.blockAccess.getBlock(par2, par3 + 1, par4 - 1).getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZNPP = this.blockAccess.getBlock(par2, par3 + 1, par4 + 1).getAmbientOcclusionLightValue();
        ...
        if (this.renderAllFaces || shouldSideBeRendered(par1Block, par2 + 1, par3, par4, 5))
        {
            ...
            this.aoLightValueScratchXYPN = this.blockAccess.getBlock(par2, par3 - 1, par4).getAmbientOcclusionLightValue();
            this.aoLightValueScratchXZPN = this.blockAccess.getBlock( par2, par3, par4 - 1).getAmbientOcclusionLightValue();
            this.aoLightValueScratchXZPP = this.blockAccess.getBlock(par2, par3, par4 + 1).getAmbientOcclusionLightValue();
            this.aoLightValueScratchXYPP = this.blockAccess.getBlock(par2, par3 + 1, par4).getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZPNN = this.blockAccess.getBlock( par2, par3 - 1, par4 - 1).getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZPNP = this.blockAccess.getBlock(par2, par3 - 1, par4 + 1).getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZPPN = this.blockAccess.getBlock(par2, par3 + 1, par4 - 1).getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZPPP = this.blockAccess.getBlock(par2, par3 + 1, par4 + 1).getAmbientOcclusionLightValue();
	...
	public boolean renderStandardBlockWithColorMultiplier(Block par1Block, int par2, int par3, int par4, float par5, float par6, float par7)
    {
        ...
        if (this.renderAllFaces || shouldSideBeRendered(par1Block, par2, par3, par4 - 1, 2))
        {
            ...
            icon = (IIcon)this.getBlockIcon(par1Block, this.blockAccess, par2, par3, par4, 2);
            this.renderFaceZNeg(par1Block, (double)par2, (double)par3, (double)par4, icon);
