...
public class PCs_ItemCompressor extends PC_Item implements PC_IPacketHandler {
	...
	public void keyHandle() {
		PC_GresRegistry.openGres("compressor", null, null, this);
	}
    ...
    public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer player){
		if (!world.isRemote){
        	...
        	if(PC_Utils.getTE(world, pos[0], pos[1], pos[2]) != null && PC_Utils.getTE(world, pos[0], pos[1], pos[2]) instanceof TileEntityChest) {
	        	TileEntityChest te = (TileEntityChest) world.getTileEntity(pos[0], pos[1], pos[2]);
	 
	        	te.func_145976_a(StatCollector.translateToLocal("item.PCs_ItemCompressor.normal.name") + ": ("+StatCollector.translateToLocal("container.chest")+" " + pos[0] + ":" + pos[1] + ":"+ pos[2] +")");
