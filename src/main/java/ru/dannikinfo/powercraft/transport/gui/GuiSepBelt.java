...
public class GuiSepBelt extends GuiContainer{

	private static final ResourceLocation field_147017_u = new ResourceLocation(Main.MODID, "textures/blocks/transport/separatorGui.png");
	private int inventoryRows;
	private InventoryPlayer inv_p;
	private ContainerSepBelt inv;
	
	public GuiSepBelt(Container cont) {
		super(cont);
	}
