package ru.dannikinfo.powercraft.gui.container;
...
import ru.dannikinfo.powercraft.storage.SlotNoTakeStorage;
import ru.dannikinfo.powercraft.storage.StorageSlot;

public class ContainerBigCompressor extends Container{

		private InventoryBigCompressor inv;
		private int numRows;
			
		public ContainerBigCompressor(EntityPlayer player, InventoryBigCompressor inventoryItemStorage) {
