...
public class PCli_BlockLaser extends PC_Block implements PC_IItemInfo {
	...
	public void onNeighborBlockChange(World world, int x, int y, int z, Block par5) {
		...
		if (te != null) {
			...
			if (!world.isRemote)
				PC_PacketHandler.sendToAll(new PC_PacketLaser(new Object[] { x, y, z, powered }));
		}
	...
	public boolean renderInventoryBlock(int metadata, Object renderer) {
		...
		PC_Utils.setBlockBounds(Blocks.cobblestone, 0.0F, 0.0F, 0.0F, 1.0F, 0.2F, 1.0F);
		PC_Renderer.renderInvBox(renderer, Blocks.cobblestone, 0);
		PC_Utils.setBlockBounds(Blocks.cobblestone, 0.4F, 0.2F, 0.4F, 0.6F, 0.3F, 0.6F);
		PC_Renderer.renderInvBox(renderer, Blocks.cobblestone, 0);
		// reset
		PC_Utils.setBlockBounds(Blocks.cobblestone, 0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F);
