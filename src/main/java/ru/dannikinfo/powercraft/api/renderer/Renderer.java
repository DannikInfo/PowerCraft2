...
import ru.dannikinfo.powercraft.api.utils.VecF;

public class Renderer{
    protected static int render3dId;
    protected static int render2dId;
    protected static Renderer renderer3d;
    protected static Renderer renderer2d;
    protected boolean render3d;

    public Renderer(boolean render3d)
    {
	...
	protected void irenderEntityLabelAt(String label, VecF realPos, int viewDistance, float yOffset, double x, double y, double z) {}
	
	public static void renderEntityLabelAt(String label, VecF realPos, int viewDistance, float yOffset, double x, double y, double z) {
