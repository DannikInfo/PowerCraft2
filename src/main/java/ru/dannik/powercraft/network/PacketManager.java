package ru.dannik.powercraft.network;
...
import ru.dannik.powercraft.network.server.DistanceDetectorMessage;
...
public class PacketManager
{
	...
	public static final void registerPackets() {
		...
		registerMessage(ClearSpawnerMessage.class);
		registerMessage(ChangeMobSpawnerMessage.class);
	...
	private static final <T extends AbstractMessage<T> & IMessageHandler<T, IMessage>> void registerMessage(Class<T> clazz) {
		...
		if (AbstractMessage.AbstractClientMessage.class.isAssignableFrom(clazz)) {
			PacketManager.dispatcher.registerMessage(clazz, clazz, packetId++, Side.CLIENT);
		} else if (AbstractMessage.AbstractServerMessage.class.isAssignableFrom(clazz)) {
			PacketManager.dispatcher.registerMessage(clazz, clazz, packetId++, Side.SERVER);
		} else {
	...
	public static final void sendTo(IMessage message, EntityPlayerMP player) {
		PacketManager.dispatcher.sendTo(message, player);
	}
	...
	public static void sendToAll(IMessage message) {
		PacketManager.dispatcher.sendToAll(message);
	}
	...
	public static final void sendToAllAround(IMessage message, NetworkRegistry.TargetPoint point) {
		PacketManager.dispatcher.sendToAllAround(message, point);
	}
	...
	public static final void sendToAllAround(IMessage message, int dimension, double x, double y, double z, double range) {
		PacketManager.sendToAllAround(message, new NetworkRegistry.TargetPoint(dimension, x, y, z, range));
	}
	...
	public static final void sendToAllAround(IMessage message, EntityPlayer player, double range) {
		PacketManager.sendToAllAround(message, player.worldObj.provider.dimensionId, player.posX, player.posY, player.posZ, range);
	}
	...
	public static final void sendToDimension(IMessage message, int dimensionId) {
		PacketManager.dispatcher.sendToDimension(message, dimensionId);
	}
	...
	public static final void sendToServer(IMessage message) {
		PacketManager.dispatcher.sendToServer(message);
	}
}
