...
public class PC_PacketSyncLightClient extends AbstractClientMessage<PC_PacketSyncLightClient> {

	NBTTagCompound nbt = new NBTTagCompound();

	public PC_PacketSyncLightClient() {
	}

	public PC_PacketSyncLightClient(Object... o) {
