...
public class PC_GuiUpdate extends GuiScreen {
	...
	public void initGui() {
		...
		buttonList.add(download = new GuiButton(2, 220, height - 58, width-240, 20, StatCollector.translateToLocal("Download")));
		buttonList.add(new GuiButton(3, 220, height - 28, width-240, 20, StatCollector.translateToLocal("Where to watch for downloads")));
		buttonList.add(activate = new GuiButton(4, 220, height - 58, (width-240)/2, 20, StatCollector.translateToLocal("Activate")));
		buttonList.add(delete = new GuiButton(5, 220+(width-240)/2, height - 58, (width-240)/2, 20, StatCollector.translateToLocal("Delete")));
