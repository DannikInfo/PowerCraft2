...
public class BeltHelper
{
    ...
    public static void doSpecialItemAction(World world, VecI beltPos, EntityItem entity)
    {
    ...
    public static boolean storeNearby(World world, VecI pos, EntityItem entity, boolean ignoreStorageBorder)
    {
        ...
        if (isBeyondStorageBorder(world, rot, pos, entity, STORAGE_BORDER) || ignoreStorageBorder)
        {
            ...
            if (rot != Direction.BACK && rot != Direction.FRONT && storeEntityItemAt(world, pos.offset(0, 0, -1), entity, Direction.BACK))
            {
                return true;
            }

            if (rot != Direction.LEFT && rot != Direction.RIGHT && storeEntityItemAt(world, pos.offset(1, 0, 0), entity, Direction.RIGHT))
            {
                return true;
            }

            if (rot != Direction.FRONT && rot != Direction.BACK && storeEntityItemAt(world, pos.offset(0, 0, 1), entity, Direction.FRONT))
            {
                return true;
            }

            if (rot != Direction.RIGHT && rot != Direction.LEFT && storeEntityItemAt(world, pos.offset(-1, 0, 0), entity, Direction.LEFT))
            {
                return true;
            }

            if (storeEntityItemAt(world, pos.offset(0, 1, 0), entity, Direction.TOP))
            {
                return true;
            }
        }
    ...
    public static boolean storeItemIntoMinecart(World world, VecI beltPos, EntityItem entity)
    {
    ...
    public static void entityPreventDespawning(World world, VecI pos, boolean preventPickup, Entity entity)
    {
            ...
            double max_horizontal_speed, double horizontal_boost)
    {
        ...
        motionY = MathHelper.clamp_float((float) entity.motionY, (float) - max_horizontal_speed, (float) max_horizontal_speed);
    ...
    public static boolean storeAllSides(World world, VecI pos, EntityItem entity)
    {
        if (storeItemIntoMinecart(world, pos, entity))
        {
            return true;
        ...
        if (storeEntityItemAt(world, pos.offset(0, 0, -1), entity, Direction.BACK))
        {
            return true;
        }

        if (storeEntityItemAt(world, pos.offset(0, 0, 1), entity, Direction.FRONT))
        {
            return true;
        }

        if (storeEntityItemAt(world, pos.offset(-1, 0, 0), entity, Direction.LEFT))
        {
            return true;
        }

        if (storeEntityItemAt(world, pos.offset(1, 0, 0), entity, Direction.RIGHT))
        {
            return true;
        }
        ...
        if (storeEntityItemAt(world, pos.offset(0, -1, 0), entity, Direction.BOTTOM))
        {
            return true;
        }
    ...
    public static boolean dispenseItemOntoBelt(World world, VecI invPos, IInventory inventory, VecI beltPos)
    {
    ...
    public static boolean dispenseStackFromNearbyMinecart(World world, VecI beltPos)
    {
        ...
        if (hitList.size() > 0)
        {
            ...
            {
                if (dispenseItemOntoBelt(world, new VecI((int)(entityWithInventory.posX+0.5), (int)(entityWithInventory.posY+0.5), (int)(entityWithInventory.posZ+0.5)),
        ...
        if (hitList2.size() > 0)
        {
            ...
            {
                if (((IInventoryWrapper)entityWithInventory).getInventory() != null)
                {
                    if (dispenseItemOntoBelt(world, new VecI((int)(entityWithInventory.posX+0.5), (int)(entityWithInventory.posY+0.5), (int)(entityWithInventory.posZ+0.5)),
                            ((IInventoryWrapper) entityWithInventory).getInventory(), beltPos))
                    {
                        return true;
                    }
                }
    ...
    public static void createEntityItemOnBelt(World world, VecI invPos, VecI beltPos, ItemStack stack)
    {
        ...
        item.motionY = 0.0D;
        item.motionZ = 0.0D;
        VecI vector = beltPos.copy().sub(invPos);
