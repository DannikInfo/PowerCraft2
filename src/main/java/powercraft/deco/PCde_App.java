...
public class PCde_App {
	...
	public List<PC_IRecipe> initRecipes(List<PC_IRecipe> recipes) {
		...
		GameRegistry.addRecipe(new ItemStack(chimney, 6, 2),
				new Object[] { "X X", "X X", "X X", 'X', Blocks.stonebrick });
		...
		// new PC_ItemStack(platform, 1), new ItemStack(platform, 1), new
		// ItemStack(platform, 1)));

		// recipes.add(new PC_ShapelessRecipes(new ItemStack(Items.iron_ingot),
		// new PC_ItemStack(stairs, 1),new ItemStack(stairs, 1),new ItemStack(stairs,
		// 1)));
		return recipes;
	}
