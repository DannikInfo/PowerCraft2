package ru.dannikinfo.powercraft.api.renderer;
...
public class PCRenderBlocks extends RenderBlocks {

	public PCRenderBlocks(IBlockAccess blockAccess){
		super(blockAccess);
	}
	...
	public boolean renderStandardBlockWithAmbientOcclusion(Block par1Block, int par2, int par3, int par4, float par5, float par6, float par7)
    {
        ...
        if (this.renderAllFaces || shouldSideBeRendered(par1Block, par2, par3 - 1, par4, 0))
        {
            ...
            this.aoLightValueScratchXYNN = par1Block.getAmbientOcclusionLightValue();
            this.aoLightValueScratchYZNN = par1Block.getAmbientOcclusionLightValue();
            this.aoLightValueScratchYZNP = par1Block.getAmbientOcclusionLightValue();
            this.aoLightValueScratchXYPN = par1Block.getAmbientOcclusionLightValue();
            flag3 = Blocks.grass.getCanBlockGrass();//[this.blockAccess.getBlock(par2 + 1, par3 - 1, par4)];
            flag2 = Blocks.grass.getCanBlockGrass();//Block.canBlockGrass[this.blockAccess.getBlock(par2 - 1, par3 - 1, par4)];
            flag5 = Blocks.grass.getCanBlockGrass();//Block.canBlockGrass[this.blockAccess.getBlock(par2, par3 - 1, par4 + 1)];
            flag4 = Blocks.grass.getCanBlockGrass();//Block.canBlockGrass[this.blockAccess.getBlock(par2, par3 - 1, par4 - 1)];
            ...
            {
                this.aoLightValueScratchXYZNNN = par1Block.getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZNNP = par1Block.getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZPNN = par1Block.getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZPNP = par1Block.getAmbientOcclusionLightValue();
            ...
            f7 = par1Block.getAmbientOcclusionLightValue();
        ...
        if (this.renderAllFaces || shouldSideBeRendered(par1Block, par2, par3 + 1, par4, 1))
        {
            ...
            this.aoLightValueScratchXYNP = par1Block.getAmbientOcclusionLightValue();
            this.aoLightValueScratchXYPP = par1Block.getAmbientOcclusionLightValue();
            this.aoLightValueScratchYZPN = par1Block.getAmbientOcclusionLightValue();
            this.aoLightValueScratchYZPP = par1Block.getAmbientOcclusionLightValue();
            flag3 = Blocks.grass.getCanBlockGrass();//Block.canBlockGrass[this.blockAccess.getBlockId(par2 + 1, par3 + 1, par4)];
            flag2 = Blocks.grass.getCanBlockGrass();//Block.canBlockGrass[this.blockAccess.getBlockId(par2 - 1, par3 + 1, par4)];
            flag5 = Blocks.grass.getCanBlockGrass();//Block.canBlockGrass[this.blockAccess.getBlockId(par2, par3 + 1, par4 + 1)];
            flag4 = Blocks.grass.getCanBlockGrass();//Block.canBlockGrass[this.blockAccess.getBlockId(par2, par3 + 1, par4 - 1)];
            ...
            {
                this.aoLightValueScratchXYZNPN = par1Block.getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZPPN = par1Block.getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZNPP = par1Block.getAmbientOcclusionLightValue();
            ...
            {
                this.aoLightValueScratchXYZPPP = par1Block.getAmbientOcclusionLightValue();
        ...
        if (this.renderAllFaces || shouldSideBeRendered(par1Block, par2, par3, par4 - 1, 2))
        {
            ...
            this.aoLightValueScratchXZNN = par1Block.getAmbientOcclusionLightValue();
            this.aoLightValueScratchYZNN = par1Block.getAmbientOcclusionLightValue();
            this.aoLightValueScratchYZPN = par1Block.getAmbientOcclusionLightValue();
            this.aoLightValueScratchXZPN = par1Block.getAmbientOcclusionLightValue();
            ...
            flag3 = Blocks.grass.getCanBlockGrass();//Block.canBlockGrass[this.blockAccess.getBlockId(par2 + 1, par3, par4 - 1)];
            flag2 = Blocks.grass.getCanBlockGrass();//Block.canBlockGrass[this.blockAccess.getBlockId(par2 - 1, par3, par4 - 1)];
            flag5 = Blocks.grass.getCanBlockGrass();// Block.canBlockGrass[this.blockAccess.getBlockId(par2, par3 + 1, par4 - 1)];
            flag4 = Blocks.grass.getCanBlockGrass();//Block.canBlockGrass[this.blockAccess.getBlockId(par2, par3 - 1, par4 - 1)];
            ...
            this.renderFaceZNeg(par1Block, (double)par2, (double)par3, (double)par4, (IIcon) icon);

            if (fancyGrass && icon.equals("grass_side") && !this.hasOverrideBlockTexture())
            {
        ...
        if (this.renderAllFaces || shouldSideBeRendered(par1Block, par2, par3, par4 + 1, 3))
        {
            ...
            this.aoLightValueScratchXZNP = par1Block.getAmbientOcclusionLightValue();
            this.aoLightValueScratchXZPP = par1Block.getAmbientOcclusionLightValue();
            this.aoLightValueScratchYZNP = par1Block.getAmbientOcclusionLightValue();
            this.aoLightValueScratchYZPP = par1Block.getAmbientOcclusionLightValue();
            ...
            this.colorGreenTopRight *= f6;
            this.colorBlueTopRight *= f6;
            icon = (Icon) this.getBlockIcon(par1Block, this.blockAccess, par2, par3, par4, 3);
        ...
        if (this.renderAllFaces || shouldSideBeRendered(par1Block, par2 - 1, par3, par4, 4))
        {
            ...
            flag3 = Blocks.grass.getCanBlockGrass();//Block.canBlockGrass[this.blockAccess.getBlockId(par2 - 1, par3 + 1, par4)];
            flag2 = Blocks.grass.getCanBlockGrass();//Block.canBlockGrass[this.blockAccess.getBlockId(par2 - 1, par3 - 1, par4)];
            flag5 = Blocks.grass.getCanBlockGrass();// Block.canBlockGrass[this.blockAccess.getBlockId(par2 - 1, par3, par4 - 1)];
            flag4 = Blocks.grass.getCanBlockGrass();//Block.canBlockGrass[this.blockAccess.getBlockId(par2 - 1, par3, par4 + 1)];
            ...
            this.colorGreenTopRight *= f6;
            this.colorBlueTopRight *= f6;
            icon = (Icon) this.getBlockIcon(par1Block, this.blockAccess, par2, par3, par4, 4);
            this.renderFaceXNeg(par1Block, (double)par2, (double)par3, (double)par4, (IIcon) icon);
        ...
        if (this.renderAllFaces || shouldSideBeRendered(par1Block, par2 + 1, par3, par4, 5))
        {
            ...
            this.colorGreenTopRight *= f6;
            this.colorBlueTopRight *= f6;
            icon = (Icon) this.getBlockIcon(par1Block, this.blockAccess, par2, par3, par4, 5);
            this.renderFaceXPos(par1Block, (double)par2, (double)par3, (double)par4, (IIcon) icon);
	...
	public boolean renderStandardBlockWithColorMultiplier(Block par1Block, int par2, int par3, int par4, float par5, float par6, float par7)
    {
        ...
        if (this.renderAllFaces || shouldSideBeRendered(par1Block, par2, par3, par4 + 1, 3))
        {
            ...
            tessellator.setColorOpaque_F(f11, f14, f17);
            icon = (Icon) this.getBlockIcon(par1Block, this.blockAccess, par2, par3, par4, 3);
            this.renderFaceZPos(par1Block, (double)par2, (double)par3, (double)par4, (IIcon) icon);
