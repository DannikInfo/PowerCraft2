...
public class PC_WorldGenerator implements IWorldGenerator{
	 ...
	 * @param world The world (not the dimension) in which this block should be generated
	 * @param random Random number to get block generation coordinates
	 * @param blockXPos The number to have an empty space along the X coordinates for the generation method (uses quartz ore)
	 * @param blockZPos The number to have an empty space along the Z coordinates for the generation method (uses quartz ore)
	 * @param maxX The number that sets the maximum X coordinate to generate ore on the X axis per chunk
	 * @param maxZ The number that sets the maximum Z coordinate to generate ore on the Z axis per chunk
