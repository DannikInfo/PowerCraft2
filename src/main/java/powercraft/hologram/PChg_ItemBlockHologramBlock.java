...
public class PChg_ItemBlockHologramBlock extends PC_ItemBlock {
	...
	public PChg_ItemBlockHologramBlock(Block block) {
		super(block);
	...
	public boolean placeBlockAt(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side,
		...
		if (!PC_Utils.setBID(world, x, y, z, Block.getBlockFromItem(this.getContainerItem()), metadata)) {
			return false;
		}

		if (world.getBlock(x, y, z) == Block.getBlockFromItem(this.getContainerItem())) {
			Block block = Block.getBlockFromItem(this.getContainerItem());
