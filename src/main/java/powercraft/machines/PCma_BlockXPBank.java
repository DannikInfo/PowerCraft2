...
public class PCma_BlockXPBank extends PC_Block implements PC_IItemInfo {
	...
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Object renderer) {
		int xp = ((PCma_TileEntityXPBank) world.getTileEntity(x, y, z)).getXP();
		setBlockBounds(0.15F, 0.29F - 0.2F * calculateHeightMultiplier(xp), 0.15F, 0.85F,
				0.71F + 0.2F * calculateHeightMultiplier(xp), 0.85F);
		PC_Renderer.renderStandardBlock(renderer, this, x, y, z);
		setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F);
		PC_Utils.setBlockBounds(Blocks.obsidian, 0.0F, 0.3F, 0.0F, 1.0F, 0.7F, 1.0F);
		PC_Renderer.renderStandardBlock(renderer, Blocks.obsidian, x, y, z);
		PC_Utils.setBlockBounds(Blocks.obsidian, 0.0F, 0.0F, 0.0F, 0.15F, 0.3F, 0.15F);
		PC_Renderer.renderStandardBlock(renderer, Blocks.obsidian, x, y, z);
		PC_Utils.setBlockBounds(Blocks.obsidian, 0.85F, 0.0F, 0.0F, 1.0F, 0.3F, 0.15F);
		PC_Renderer.renderStandardBlock(renderer, Blocks.obsidian, x, y, z);
		PC_Utils.setBlockBounds(Blocks.obsidian, 0.0F, 0.0F, 0.85F, 0.15F, 0.3F, 1.0F);
		PC_Renderer.renderStandardBlock(renderer, Blocks.obsidian, x, y, z);
		PC_Utils.setBlockBounds(Blocks.obsidian, 0.85F, 0.0F, 0.85F, 1.0F, 0.3F, 1.0F);
		PC_Renderer.renderStandardBlock(renderer, Blocks.obsidian, x, y, z);
		PC_Utils.setBlockBounds(Blocks.obsidian, 0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F);
		return true;
	}
