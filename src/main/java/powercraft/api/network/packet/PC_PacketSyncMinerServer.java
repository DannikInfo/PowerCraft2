...
public class PC_PacketSyncMinerServer extends AbstractServerMessage<PC_PacketSyncMinerServer> {

	NBTTagCompound nbt = new NBTTagCompound();

	public PC_PacketSyncMinerServer() {
	}

	public PC_PacketSyncMinerServer(Object... o) {
	...
	public void process(EntityPlayer player, Side side) {
		if (side.isServer()) {
			...
			if(player.worldObj.getEntityByID((int)o[0]) instanceof PCmo_EntityMiner) {
				...
				//if((String)o[1] == "doInfoSet") {
				//}
				//if((String)o[1] == "setInfo") {
